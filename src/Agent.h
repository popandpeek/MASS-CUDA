...
public:
	...
	/**
	 *  Is the Agent initializer. 
	 *  A contiguous space of arguments is passed to the constructor.
	 *		This function must be implemented to use args to initialize any
	 *		user defined fields. 
	 *
 ...
 ******************************************************************************/
	...
	/**
	 *  \brief Create an Agent with no parameters.
	 *  \details This defaults internal values to mostly useless things
	 *  like NULL and 0. It will be necessary to run the init() function
	 *  after you use this constructor.
	 *  
	 *  \sa init( void* args)
	 */
	 ...
	 */
	__host__ __device__ virtual int map( int initPopulation, int *size, int index );

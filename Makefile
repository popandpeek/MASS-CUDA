...
app: objlib objtest
	nvcc -Wno-deprecated-gpu-targets -rdc=true -std=c++11 -lcurand -L/usr/local/cuda/lib64 obj/test/*.o lib/mass_cuda.a -o bin/app
	#chmod +x bin/app
...
objlib:
	...
	nvcc -Wno-deprecated-gpu-targets -rdc=true -std=c++11 -c src/Partition.cu -o obj/lib/Partition.o
	...
	nvcc -Wno-deprecated-gpu-targets -rdc=true -std=c++11 -c src/PlacesPartition.cu -o obj/lib/PlacesPartition.o
